...
|ConfigFileTransformation|Optional    |Defines the transformation applied to the configuration file.<br>`configFile`: the configuration file to transform (optional)<br>`Transformation:` The applied to the file.|

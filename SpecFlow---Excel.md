SpecFlow+ Excel is a SpecFlow plugin that allows describing requirements in Excel files. These requirements can be used in a same way as normal plain-text Gherkin feature files.
